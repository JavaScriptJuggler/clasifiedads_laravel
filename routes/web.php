...
Route::prefix('admin')->group(function () {
    ...
    Route::controller(usersController::class)
        ...
        ->group(function () {
            ...
            Route::get('/get-unapproved-ads/{userid}', 'getUnApprovedAds')->name('get-unapproved-ads')->middleware(['restrict-page']);
            Route::get('/show-unapproved-ads/{recordid}/{userid}', 'showUnapprovedAds')->name('show-unapproved-ads')->middleware(['restrict-page']);
