        ...
        <div class="row m-2">
            <div class="col-lg-6">
                <div class="blog-slider slider-arrow">
                    <div class="blog-card" style="height:auto">
                        <div class="blog-img">
                            <img src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/banner_listbusiness.png"
                                alt="blog">
                        </div>
                    </div>
                    <div class="blog-card" style="height:auto">
                ...
                @for ($i = 0; $i < 12; $i++)
                    <div class="col-sm-5 col-md-5 col-lg-3 col-xl-2">
                        <div class="product-card">
                            <div class="product-media">
                                <div class="product-img">
                                    <img src="https://stimg2.cardekho.com/images/carNewsEditorImages/userimages/20211013_123655/27941/oem-name0.jpg?impolicy=resize&imwidth=420"
                                        alt="product">
                                </div>
                            </div>
                        </div>
    ...
    <section class="section niche-part">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-center-heading">
                        <h2>Top Ads From <span>Categories</span></h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit aspernatur illum vel sunt libero
                            voluptatum repudiandae veniam maxime tenetur.</p>
                    </div>
                </div>
            ...
            <div class="row p-lg-5 p-md-5">
                <div class="col-lg-12">
                    <div class="niche-nav">
                        <ul class="nav nav-tabs">
                            <li><a href="#ratings1" class="nav-link active" data-toggle="tab">Category 1</a></li>
                            <li><a href="#advertiser1" class="nav-link" data-toggle="tab">Category 2</a></li>
                            <li><a href="#engaged1" class="nav-link" data-toggle="tab">Category 3</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        @for ($i = 0; $i < 12; $i++)
                            <div class="col-sm-6 col-md-6 col-lg-2">
                                <a href="ad-list-column3.html" class="city-card"
                                    style="background: url(/frontend_assets/images/cities/01.jpg) no-repeat center; background-size: cover;height: 160px !important;
                                width: 100% !important;">
