                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <!-- <div align="center" class="alignment" style="line-height:10px"><img alt="your-logo" src="images/LOGO.png" style="display: block; height: auto; border: 0; width: 125px; max-width: 100%;" title="your-logo" width="125"/></div> -->
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td class="column column-1"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img alt="reset-password"
                                                                        class="big"
                                                                        src="{{ asset('email-template-images/gif-resetpass.gif') }}"
                                                    ...
                                                    <table border="0" cellpadding="15" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div align="center" class="alignment">
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="www.yourwebsite.com" style="height:57px;width:273px;v-text-anchor:middle;" arcsize="36%" strokeweight="0.75pt" strokecolor="#FFC727" fillcolor="#ffc727"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#393d47; font-family:Tahoma, Verdana, sans-serif; font-size:18px"><![endif]--><a
                                                                        href="{{ $actionUrl }}"
                                                                    ...
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:10px;">This link
                                                                                will expire in 60 minutes. If you
                                                                                continue
                                                                                ...
                                                                                to contact us at <a
                                                                                    ...
                                                                                    target="_blank"
                                                                                    title="support@youremail.com">support@youremail.com</a>.</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                                        ...
                                                                        <tr>
                                                                            <td style="padding:0 5px 0 5px;"><a
                                                                                    ...
                                                                                    target="_self"><img alt="Facebook"
                                                                                        height="32"
                                                                                        src="{{ asset('email-template-images/facebook2x.png') }}"
                                                                            ...
                                                                            <td style="padding:0 5px 0 5px;"><a
                                                                                    ...
                                                                                    target="_self"><img alt="Twitter"
                                                                                        height="32"
                                                                                        src="{{ asset('email-template-images/twitter2x.png') }}"
                                                                                        style="display: block; height: auto; border: 0;"
                                                                                        title="Twitter"
                                                                                        width="32" /></a></td>
                                                                            <td style="padding:0 5px 0 5px;"><a
                                                                                    ...
                                                                                    target="_self"><img
                                                                                        ...
                                                                                        src="{{ asset('email-template-images/instagram2x.png') }}"
                                                                                        style="display: block; height: auto; border: 0;"
                                                                                        title="Instagram"
                                                                                        width="32" /></a></td>
                                                                            <td style="padding:0 5px 0 5px;"><a
                                                                                    ...
                                                                                    target="_self"><img alt="LinkedIn"
                                                                                        height="32"
                                                                                        src="{{ asset('email-template-images/linkedin2x.png') }}"
                                                                                        style="display: block; height: auto; border: 0;"
                                                                                        title="LinkedIn"
                                                                                        width="32" /></a></td>
                                                                        </tr>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        class="html_block block-3" role="presentation"
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
                                                        width="100%">
                                                        <tr>
                                                            <td class="pad">
                                                                ...
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            This email is auto-generated.Don't reply to
                                                                            this email</p>
                                                                        <p
                                                                            style="margin: 0; text-align: center; mso-line-height-alt: 14.399999999999999px;">
                                                                        </p>
                                                                        <p
                                                                            ...
                                                                            /  info@example.com / (+1) 123 456 789<a
